...
public class Exercicio9_CreadorXanela extends Application {
	
	private List<Stage> xanelaFillas = new ArrayList<>();
	...
	public void start(Stage stage) throws Exception {
		...
		stage.setTitle("Exercicio 9");
		stage.setScene(scene);
		stage.show();

	}

	public void AbrirXanela(Stage stage, StageStyle estilo, Modality modalidade, Double opacity, boolean Redimensionable) {
		...
		xanelaFillas.add(xanela);
		xanela.setTitle("Xanela filla" + xanelaFillas.size());
